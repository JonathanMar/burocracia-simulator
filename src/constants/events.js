...
export const RANDOM_EVENTS = [
  ...
  { id:"bribery",   emoji:"💰", title:"ENVELOPE SUSPEITO!",    desc:"Um envelope com dinheiro foi deixado junto ao próximo documento. O que você faz?", duration:99999, effect:"bribery" },
];
