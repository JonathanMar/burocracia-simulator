...
export default function TopBar({ level, pending, printer, docsPerMin, muted, toggleMute, timeLeft, score, unlocked, combo, comboMult }) {
  ...
  return (
    <div style={{flexShrink:0,background:"#060610",borderBottom:"1px solid #1a1a2e",padding:"6px 16px",display:"flex",alignItems:"center",gap:14}}>
      ...
      <div style={{flex:1,textAlign:"center"}}>
        ...
        <div style={{color:"#555",fontSize:9}}><span title="[A] Aprovar  [R] Rejeitar  [Tab] Próx. doc" style={{cursor:"help",color:"#668866"}}>⌨ atalhos: A/R/Tab</span></div>
      </div>
      {/* Combo badge */}
      {combo >= 2 && (
